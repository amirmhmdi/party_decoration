...
mixin _$ProductEntity {
 ...
 String get name; String get description; double get price; double get discount; double get rate; ReviewEntity get review; List<String> get packageInclutionList; List<FaqEntity> get faqList; List<String> get deliveryDetails; List<String> get careInfoList; EnumProductTag get productTag; DateTime? get cacheTime;
...
@override
int get hashCode => Object.hash(runtimeType,name,description,price,discount,rate,review,const DeepCollectionEquality().hash(packageInclutionList),const DeepCollectionEquality().hash(faqList),const DeepCollectionEquality().hash(deliveryDetails),const DeepCollectionEquality().hash(careInfoList),productTag,cacheTime);

@override
String toString() {
  return 'ProductEntity(name: $name, description: $description, price: $price, discount: $discount, rate: $rate, review: $review, packageInclutionList: $packageInclutionList, faqList: $faqList, deliveryDetails: $deliveryDetails, careInfoList: $careInfoList, productTag: $productTag, cacheTime: $cacheTime)';
}
...
@useResult
$Res call({
 String name, String description, double price, double discount, double rate, ReviewEntity review, List<String> packageInclutionList, List<FaqEntity> faqList, List<String> deliveryDetails, List<String> careInfoList, EnumProductTag productTag, DateTime? cacheTime
});
...
/// Create a copy of ProductEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = null,Object? description = null,Object? price = null,Object? discount = null,Object? rate = null,Object? review = null,Object? packageInclutionList = null,Object? faqList = null,Object? deliveryDetails = null,Object? careInfoList = null,Object? productTag = null,Object? cacheTime = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name,  String description,  double price,  double discount,  double rate,  ReviewEntity review,  List<String> packageInclutionList,  List<FaqEntity> faqList,  List<String> deliveryDetails,  List<String> careInfoList,  EnumProductTag productTag,  DateTime? cacheTime)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ProductEntity() when $default != null:
return $default(_that.name,_that.description,_that.price,_that.discount,_that.rate,_that.review,_that.packageInclutionList,_that.faqList,_that.deliveryDetails,_that.careInfoList,_that.productTag,_that.cacheTime);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name,  String description,  double price,  double discount,  double rate,  ReviewEntity review,  List<String> packageInclutionList,  List<FaqEntity> faqList,  List<String> deliveryDetails,  List<String> careInfoList,  EnumProductTag productTag,  DateTime? cacheTime)  $default,) {final _that = this;
switch (_that) {
case _ProductEntity():
return $default(_that.name,_that.description,_that.price,_that.discount,_that.rate,_that.review,_that.packageInclutionList,_that.faqList,_that.deliveryDetails,_that.careInfoList,_that.productTag,_that.cacheTime);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String name,  String description,  double price,  double discount,  double rate,  ReviewEntity review,  List<String> packageInclutionList,  List<FaqEntity> faqList,  List<String> deliveryDetails,  List<String> careInfoList,  EnumProductTag productTag,  DateTime? cacheTime)?  $default,) {final _that = this;
switch (_that) {
case _ProductEntity() when $default != null:
return $default(_that.name,_that.description,_that.price,_that.discount,_that.rate,_that.review,_that.packageInclutionList,_that.faqList,_that.deliveryDetails,_that.careInfoList,_that.productTag,_that.cacheTime);case _:
  return null;
...
class _ProductEntity implements ProductEntity {
  const _ProductEntity({required this.name, required this.description, required this.price, required this.discount, required this.rate, required this.review, required final  List<String> packageInclutionList, required final  List<FaqEntity> faqList, required final  List<String> deliveryDetails, required final  List<String> careInfoList, required this.productTag, this.cacheTime}): _packageInclutionList = packageInclutionList,_faqList = faqList,_deliveryDetails = deliveryDetails,_careInfoList = careInfoList;
...
@override
int get hashCode => Object.hash(runtimeType,name,description,price,discount,rate,review,const DeepCollectionEquality().hash(_packageInclutionList),const DeepCollectionEquality().hash(_faqList),const DeepCollectionEquality().hash(_deliveryDetails),const DeepCollectionEquality().hash(_careInfoList),productTag,cacheTime);
...
/// Create a copy of ProductEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = null,Object? description = null,Object? price = null,Object? discount = null,Object? rate = null,Object? review = null,Object? packageInclutionList = null,Object? faqList = null,Object? deliveryDetails = null,Object? careInfoList = null,Object? productTag = null,Object? cacheTime = freezed,}) {
